    ...
    <div class="content-wrapper">
        <div class="container-fluid fade-in overflow-auto" style="max-height: 100vh;">
            ...
            @if (session('videoTerhapus'))
                <div class="modal fade" id="videoTerhapusModal" tabindex="-1" aria-labelledby="videoTerhapusModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                        ...
                        <tbody class="text-center">
                            @foreach ($video as $no => $data)
                                <tr>
                                    ...
                                    <td>{{ $data->created_at ? $data->created_at->format('d M Y') : 'Tanggal tidak tersedia' }}
                                    </td>
                                    <td>
                                        <form action="{{ route('admin.hapusVideo', $data->id) }}" method="POST"
