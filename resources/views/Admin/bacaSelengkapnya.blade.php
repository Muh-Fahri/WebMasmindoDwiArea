...
<div class="content-wrapper bg-white">
    <div class="container-fluid overflow-auto" style="max-height: 100vh">
        <div class="container p-5">
            <div class="row p-5">
                <div class="col">
                    <img style="object-fit: cover;height:50vh" class="w-100" src="{{ asset('berita/'.$selengkapnya->img_berita) }}" alt="">
