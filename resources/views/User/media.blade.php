    ...
    <section id="media" style="overflow-x: hidden; background-color:#F9F8F3">
        <div class="container-fluid m-0 p-0">
            <div class="row g-0">
                ...
                <div class="col-md-5 d-flex flex-column" style="max-height: 70vh;">
                    <div class="p-3 overflow-auto" style="flex: 1 1 auto;">
                        @if ($lainnya->isEmpty())
                            <div class="bg-new d-flex align-items-center justify-content-center" style="height: 50vh">
                                <h1 class="text-secondary text-center">Oops, Tidak ada data</h1>
                            </div>
                        @else
                                        ...
                                        <div class="row g-0 h-100">
                                            <div class="col-4 h-100">
                                                <img src="{{ asset('berita/' . $data->img_berita) }}"
                                                    class="w-75 h-100 rounded-start" style="object-fit: cover;"
                                                    alt="">
                                            </div>
                    ...
                    <div class="bg-sroll-project w-100 mt-3 flex-shrink-0" style="background-color: #F9F8F3">
                        <div class="container-fluid">
                            ...
                            <div class="position-relative px-4 pb-4">
                                <button style="background-color: #A99866; width: 48px; height: 48px; border-radius: 50%;"
                                ...
                                <div id="beritaUtamaScroll" class="d-flex flex-nowrap overflow-auto gap-3 px-5"
                                    style="scroll-behavior: smooth;">
                                    @foreach ($utama as $ut)
                                        <a data-aos="zoom-in-down" href="{{ route('user.selengkapnya', $ut->id) }}">
                                            <div class="card flex-shrink-0 position-relative text-white overflow-hidden"
                                                style=" min-width: clamp(180px, 22vw, 250px); aspect-ratio: 4/2;
                                                        background: linear-gradient(to right, rgba(0, 0, 0, 0.432), rgba(0, 0, 0, 0.432)),
                                                        url('{{ asset('berita/' . $ut->img_berita) }}') no-repeat center center / cover;">

                                                <div class="position-absolute bottom-0 start-0 end-0 p-3"
                                                    style="max-height: 100%; overflow: hidden;">
                                                    <h6 class="text-white text-truncate" style="font-size: 0.95rem;">
                                                        {{ $ut->judul_berita }}
                                                    </h6>
                                                    <p class="text-white"
                                                        style="font-size: 0.75rem; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical;">
                                                        {{ Str::limit($ut->isi_berita, 100, '...') }}
                                                    </p>
                                                </div>
                                            </div>
                                        </a>
