                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-success" id="gagalModalLabel">Success <i
                                    class="bi bi-exclamation-triangle"></i></h5>
                        ...
                        <div class="modal-footer">
                            <button type="button" style="width: 30%" class="btn btn-secondary rounded-5"
